    ...
    <div class="bg-wood-100">
        <section>
            <div class="mx-auto 2xl:max-w-screen-2xl md:px-12 px-8 grid py-12 space-y-6"> <img
                    class="w-full aspect-video h-full object-cover" src="{{ Vite::image('home/1.jpg') }}" alt="ImageAlt.">
            </div>
        </section>
                ...
                <div class="grid grid-cols-1 gap-10 xl:gap-24">
                    ...
                    <div>
                        <div class="prose-styles ">
                            ...
                            <p>In this code, “Inter var” and “JetBrains Mono” is the name of the font family you want to
                                use, “Inter var” and “JetBrains Mono” is the name of the font you downloaded or used the
                                CDN, and <code>defaultTheme.fontFamily</code> is the fallback font in case the custom font
                                doesn’t load.</p>
                            <h2 id="define-custom-styles">Define Custom Styles</h2>
                            <p>Once you have defined the custom font family, you can define custom styles that use it. You
                                can create a class for each style or add them to existing Tailwind CSS classes. For example,
                                you can add custom styles to the h1 class as follows:</p>

                            <p>In this code, we added custom styles to outsite the theme section to be able ot override
                                Tailwind’s classes. We added a custom font weight and line-height.</p>
                            <h2 id="apply-custom-styles">Apply Custom Styles</h2>
                            <p>To apply your custom styles to your HTML, use the class attribute and the classes you created
                                or extended in the tailwind.config.js file. For example, to apply the custom styles to an h1
                                element, add the class attribute as follows:</p>
